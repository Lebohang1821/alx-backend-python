#!/usr/bin/env python3
"""Module for unit and integration tests of client module"""
import unittest
...
class TestGithubOrgClient(unittest.TestCase):
    """It ests for `GithubOrgClient` class."""
    ...
    def test_org_method(self, org: str, resp: Dict, mocked_fxn: MagicMock) -> None:
        """It test `org` method."""
...
class TestIntegrationGithubOrgClient(unittest.TestCase):
    """It integration tests for `GithubOrgClient` class."""
    @classmethod
